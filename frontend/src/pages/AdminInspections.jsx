/**
 * Admin Inspections — view all inspections across all inspectors.
 */
  ...
  return (
    <div className="dashboard">
      <div className="page-header">
        <div>
          <h1 className="page-heading">All Inspections</h1>
          <p className="page-subheading">System-wide inspection records</p>
        </div>
      </div>
